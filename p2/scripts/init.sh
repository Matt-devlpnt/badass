...
sudo apt-get install -y python3 python3-pip pipx python3-pyqt5 python3-pyqt5.qtwebsockets python3-pyqt5.qtsvg qemu-kvm qemu-utils libvirt-clients libvirt-daemon-system virtinst software-properties-common ca-certificates curl gnupg2 
...
sudo apt-get install -y cmake make g++ libpcap-dev libelf-dev libcap-dev
...
sudo usermod -aG wireshark mcordes
